...
message.NISHTHA_BOARD =
{
    "type": "button",
    "data": {
        "text": " Please visit <a target='_blank' href='https://diksha.gov.in/%slug%/explore/1?key=%key%&channel=%channel%&primaryCategory=course&selectedTab=all&appliedFilters=true&utm_source=Tara'>DIKSHA %name%</a><br>Select the Medium and Class to view relevant subject courses on the board website.<br>",
        "buttons": [{
            "text": "Go Back",
            "value": "99",
        },
