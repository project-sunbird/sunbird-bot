...
message.TRAINING =
{
    "type": "button",
    "data": {
        "text": "  Select the course you would like to do<br>",
        "buttons": [{
            "text": "State Courses",
            "value": 1,
        },
...
message.CHOOSE_STATE_TRAINING_BOARD =
{
    "type": "button",
    "data": {
        "text": "Which state board do you belong to?<br>",
        "buttons": [{
            "text": "CBSE",
            "value": 1,
        },
...
message.TRAINING_RJ_BOARD =
{

    "intent": "greet",
    "type": "buttons",
    "data": {
        "text": "Please visit: <a target='_blank' href='https://diksha.gov.in/explore-course?channel=01246375399411712074&appliedFilters=true'>DIKSHA RJ Course</a><br>Select the Topic, Medium, Class and Subject to view relevant course on the website.<br>",
        "buttons": [
            {
                "text": "Go Back",
                "value": "99",
...
message.TRAINING_HARYANA_BOARD =
{

    "intent": "greet",
    "type": "buttons",
    "data": {
        "text": "Please visit: <a target='_blank' href='https://diksha.gov.in/explore-course?channel=01257280950159769620&appliedFilters=true'>DIKSHA HARYANA Course</a><br>Select the Topic, Medium, Class and Subject to view relevant course on the website.<br>",
        "buttons": [
            {
                "text": "Go Back",
                "value": "99",
...
message.TRAINING_OTHERS_BOARD =
{
    ...
    "type": "buttons",
    "data": {
        "text": "I understand you want to take a state training. <br>Please visit and select the Topic, Medium, Class and Subject to view relevant training.<br> <a target='_blank' href='https://diksha.gov.in/explore-course'>DIKSHA State Course</a><br>",
        "buttons": [
            {
                "text": "Go Back",
                "value": "99",
...
message.CHOOSE_IGOT_TRAINING_OPTION =
{
    "type": "button",
    "data": {
        "text": "Select what you are looking for<br>",
        "buttons": [{
...
message.OTHER_OPTIONS =
{
    "type": "buttons",
    "data": {
        "text": " Please select from the options : ",
        "intent": "greet",
        "buttons": [{
            "text": "Scan QR code",
            "value": 1,
...
message.WRONG_INPUT_AT_SECOND_LEVEL =
{
    "type": "buttons",
    "data": {
        "text": "<span>Sorry, I do not understand what you're asking. Go to Main Menu or type your query directly, so I can help you better.</span>",
        "intent": "greet",
        "buttons": [{
            "text": "Go Back",
            "value": "99",
