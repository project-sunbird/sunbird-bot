   ...
   #   redisGet = redis.get("bot_" + deviceId)
     ...
     def validate_board(self,
      ...
      #   redisSlot =  { "board":value }
        ...
        print("sender --> ", deviceId , type(deviceId) ," and ", type(str(deviceId)))
      #   print("value in validate_board -->",value)
      #   setRedisKeyValue(tracker.sender_id, value)
        ...
        if(api_matching_board in board_list):
         ...
         #   print("calling redis in if for ",tracker.sender_id," and ", str(tracker.sender_id))
         #   self.setRedisKeyValue(tracker.sender_id, value)
         #   redisValue = redisClient.get("action_"+ str(deviceId))
         #   print("redis get value", redisValue , " and ",type(redisValue))
           return value
        else:
           ...
           dispatcher.utter_message(json_message=elements)
         #   print("calling redis in else")
         #   self.setRedisKeyValue(tracker.sender_id, elements)
         #   print("redis get value"+redisClient.get("action_"+ tracker.sender_id))
           return None
